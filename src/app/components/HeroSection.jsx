        ...
        <div className='col-span-7 place-self-center text-center sm:text-left'>
          ...
          <div>
            ...
            <button 
              ...
              <a href='https://drive.google.com/file/d/15oXklHqBFBoS_cinfIo-H_r-y-12qQzI/view' target="_blank"><span className='block bg-[#121212] hover:bg-slate-800 rounded-full px-5 py-2' a>Download CV</span></a>

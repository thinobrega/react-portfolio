      ...
      <div className='grid grid-cols-1 sm:grid-cols-12'>
        <div className='col-span-7 place-self-center text-center sm:text-left'>
          ...
          <div>
            ...
            <button 
                        className='px-1 py-1 w-full bg-gradient-to-brfrom-blue-900 via-purple-600 to-cyan-300  sm:w-fit  rounded-full bg-transparent hover:bg-slate-800 text-white mt-3'>
